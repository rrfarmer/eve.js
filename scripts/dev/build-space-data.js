...
function main() {
  ...
  if (
    ...
    throw new Error(
      "Usage: node scripts/dev/build-space-data.js --invTypes <path> --invGroups <path> --mapSolarSystems <path> --mapDenormalize <path> --staStations <path> [--staStationTypes <path>] --mapJumps <path> --dgmTypeAttributes <path> (--outputDir <path> | --databaseRoot <path>) [--dump-date <YYYY-MM-DD>]",
    );
  }
